...
"lsp
if has('vim9script')
au VimEnter * call LspOptionsSet(#{aleSupport: 1, usePopupInCodeAction: 1, ignoreMissingServer: 1, noNewlineInCompletion: 1, useQuickfixForLocations: 1, completionMatcher: "icase"})
