...
tbl["m1_SPACE"] = "/global/open/target";
tbl["m1_c"] = "/global/display/cycle";
tbl["m1_g"] = "/global";
tbl["m1_n"] = "/target";
tbl["m1_?"] = "/global/input/bind";
tbl["m1_mouse1_3"] = "/target/clipboard/paste";
tbl["m1_l"] = "/target/window/select/right";
tbl["m1_k"] = "/target/window/select/up";
tbl["m1_h"] = "/target/window/select/left";
tbl["m1_j"] = "/target/window/select/down";
tbl["m1_w"] = "/target/window/destroy";
...
tbl["m1_TAB"] = "/global/workspace/switch/last";
tbl["m1_m"] = "/target/window/move_resize/fullscreen";
tbl["m1_e"] = "/target/window/swap/merge_collapse";
